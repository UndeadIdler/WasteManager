<%@ Page Title="" Language="C#" MasterPageFile="~/Content/SingleGridContracts.Master" AutoEventWireup="true" CodeBehind="AnalysisItem.aspx.cs" Inherits="WasteManagement.Content.Basic.AnalysisItem" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainCPH" runat="server">
   <f:Form ID="Form6" ShowBorder="true" ShowHeader="true" Title="条件查询" runat="server" Width="1120px" BodyPadding="5">
        <Rows>
            <f:FormRow>
                <Items>
                    <f:TextBox runat="server" Width="200px" LabelWidth="120px" Label="分析项目代码" ID="ser_vDirectiveNumber"></f:TextBox>
                    <f:TextBox runat="server" Width="200px" LabelWidth="120px" Label="分析项目名称" ShowLabel="true" ID="ser_vSaveNumber"></f:TextBox>
    ...
    <f:Grid ID="Grid1" EnableCollapse="false" PageSize="10" ShowBorder="true" ShowHeader="false"
        ...
        AllowSorting="true" SortField="OrderID" SortDirection="ASC">
                   <Columns>
                <f:RowNumberField />
                <f:BoundField DataField="ItemID" Hidden="true" />
                        <f:BoundField DataField="ItemCode" SortField="ItemCode" Width="120px" HeaderText="分析项目代码" />
                <f:BoundField DataField="ItemName" SortField="ItemName" Width="120px" HeaderText="分析项目名称" />
