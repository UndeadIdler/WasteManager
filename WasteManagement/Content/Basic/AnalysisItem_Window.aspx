<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalysisItem_Window.aspx.cs" Inherits="WasteManagement.Content.Basic.AnalysisItem_Window" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Form ID="Form2" Width="450px" LabelAlign="Right" MessageTarget="Qtip" Title="新增分析项"
            ...
            <Items>
                ...
                <Items>
                    ...
                    <f:NumberBox ID="WasteCode" Label="分析项目编码" Required="true" Width="350px" LabelWidth="100px" ShowRedStar="true"  CssClass="marginr" runat="server">
                    </f:NumberBox>
                    <f:TextBox ID="WasteName" Label="分析项目名称" Required="true" Width="350px" LabelWidth="100px"  CssClass="marginr" runat="server">
                    </f:TextBox> 
                    <f:TextBox ID="Unit"  Label="单位"  Width="350px"  LabelWidth="100px" runat="server">
                    </f:TextBox>                                        
