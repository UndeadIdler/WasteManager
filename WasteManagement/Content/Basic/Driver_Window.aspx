<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Driver_Window.aspx.cs" Inherits="WasteManagement.Content.Basic.Driver_Window" %>
...
<%--                    <f:TextBox ID="txt_bm"  Required="true" Label="常用车牌"  Width="350px"  LabelWidth="100px" runat="server" ShowRedStar="true">
                    </f:TextBox>--%>
                    <f:TextBox ID="txt_name" Label="驾驶员姓名" Required="true" Width="350px" LabelWidth="100px"  CssClass="marginr" runat="server" ShowRedStar="true">
                    </f:TextBox>                                         
