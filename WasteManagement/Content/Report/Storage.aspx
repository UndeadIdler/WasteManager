<%@ Page Title="" Language="C#" MasterPageFile="~/Content/SingleGridContracts.Master" AutoEventWireup="true" CodeBehind="Storage.aspx.cs" Inherits="WasteManagement.Content.Report.Storage" %>
            ...
            <f:FormRow>
             ...
             <f:FormRow>
                 <Items>
                    ...
                    <f:CheckBox runat="server" Width="220px" LabelWidth="95"  Text="企业名称" ShowLabel="true" ID="cb_Enterprise"></f:CheckBox>
...
<%--                       <f:BoundField DataField="ProduceName" SortField="ProduceName" Width="220px" HeaderText="企业名称" />--%>
     ...
     <f:Grid ID="Grid2" EnableCollapse="false" PageSize="10" ShowBorder="true" ShowHeader="false"
        BoxFlex="1"
        AllowPaging="true" runat="server" EnableCheckBoxSelect="True" CheckBoxSelectOnly="true"
         IsDatabasePaging="true" SortField="ProduceName"
        AllowSorting="true"  SortDirection="ASC">
                   <Columns>
                <f:RowNumberField />
