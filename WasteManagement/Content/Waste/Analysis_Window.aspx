<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Analysis_Window.aspx.cs" Inherits="WasteManagement.Content.Waste.Analysis_Window" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Form ID="Form4" Width="875px" LabelAlign="Right" MessageTarget="Qtip" Title="入厂特性分析"
            BodyPadding="5px" ShowBorder="true" ShowHeader="true" runat="server">
            <Items>
                <f:GroupPanel ID="GroupPanel1" Layout="Anchor" Width="880px" Title="基础信息" runat="server">
                    <Items>
                         <f:Panel ID="Panel3" Layout="HBox" BoxConfigAlign="Stretch" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                            <Items>
                            <f:TextBox ID="txt_BillID" Label="联单ID" Width="200px" LabelWidth="85px"  CssClass="marginr" Required="true" ShowRedStar="true"  runat="server" AutoPostBack="true"  OnTextChanged="Blur">
                                </f:TextBox>
                                <f:TextBox ID="txt_BillNumber" Label="联单号" Width="250px" LabelWidth="85px"  CssClass="marginr" Readonly="true" Required="true" ShowRedStar="true"  runat="server">
                                </f:TextBox>
                                <f:TextBox ID="txt_EName" Label="企业名称" Width="250px" LabelWidth="85px"  CssClass="marginr" Readonly="true" Required="true" ShowRedStar="true"  runat="server">
                                </f:TextBox>
                                </Items>
                        </f:Panel> 
                        <f:Panel ID="Panel1" Layout="HBox" BoxConfigAlign="Stretch" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                            <Items>
                            <f:DatePicker runat="server" ID="Date" Width="200px" LabelWidth="85px" Label="日期" DateFormatString="yyyy-MM-dd"></f:DatePicker>
                                <f:TextBox ID="txt_Analysis" EmptyText="请输入分析员名称来搜寻" Label="分析员" ShowLabel="true"  Required="true" ShowRedStar="true" LabelWidth="90px"  
                        runat="server" Width="255px"></f:TextBox>
                    <f:HiddenField ID="hf_AnalysisID" runat="server"></f:HiddenField>
                                </Items>
                        </f:Panel> 
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="分析结果（双击编辑）" EnableCollapse="true" Width="850px"
    ...
    <script type="text/javascript">
        ...
        var textbox2ID = '<%= txt_BillNumber.ClientID %>';
...
//            var cache2= {};
            ...
            var textbox3ID = '<%= txt_BillID.ClientID %>';
...
//                    $.getJSON("BillNumber.ashx", request, function (data2, status, xhr) {
//                        cache2[term] = data2;
//                        response(data2);
//                    });
//                }
//            });
            ...
            $('#' + textbox3ID + ' input').autocomplete({
                ...
                source: function (request, response) {
                    ...
                    $.getJSON("BillID.ashx", request, function (data3, status, xhr) {
                        cache3[term] = data3;
                        response(data3);
                    });
                }
