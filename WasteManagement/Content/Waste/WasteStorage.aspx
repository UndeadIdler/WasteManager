    ...
    <f:Grid ID="Grid1" EnableCollapse="false" PageSize="10" ShowBorder="true" ShowHeader="false"
        ...
        AllowSorting="true" SortField="StorageID" SortDirection="ASC">
                ...
                <f:BoundField DataField="BillID" SortField="BillID" Width="120px" HeaderText="联单ID" />
                       <f:BoundField DataField="BillNumber" SortField="BillNumber" Width="160px" HeaderText="联单号" />
                       ...
                       <f:BoundField DataField="Amount" SortField="Amount" Width="50px" HeaderText="数量" />
                       ...
                       <f:BoundField DataField="RealName" SortField="RealName" Width="50px" HeaderText="驾驶员" />
                       <f:BoundField DataField="ReceiverName" SortField="ReceiverName" Width="50px" HeaderText="签收人" />
