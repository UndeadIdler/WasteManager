...
<body>
    <form id="form1" runat="server">
        ...
        <f:Form ID="Form4" Width="875px" LabelAlign="Right" MessageTarget="Qtip" Title="废物出库和成品入库"
            BodyPadding="5px" ShowBorder="true" ShowHeader="true" runat="server">
            <Items>
                <f:GroupPanel ID="GroupPanel1" Layout="Anchor" Width="880px" Title="废酸出库" runat="server">
                    <Items>
