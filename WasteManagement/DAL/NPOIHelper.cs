...
namespace DAL
{
    public static class NPOIHelper
    {
        ...
        /// <param name="dtSource">源DataTable</param>
        /// <param name="strHeaderText">表头文本</param>
        public static MemoryStream ExportEx(DataTable dtSource, string strHeaderText)
        {
            HSSFWorkbook workbook = new HSSFWorkbook();
            ISheet sheet = workbook.CreateSheet();
        ...
        /// <param name="strHeaderText">表头文本</param>
        /// <param name="strFileName">文件名</param>
        public static void ExportByWebEx(DataTable dtSource, string strHeaderText, string strFileName)
        {
            HttpContext curContext = HttpContext.Current;
            ...
            curContext.Response.BinaryWrite(ExportEx(dtSource, strHeaderText).GetBuffer());
            HttpContext.Current.ApplicationInstance.CompleteRequest();
            //curContext.Response.End();
        }
        ...
        /// <param name="strHeaderText">表头文本</param>
        /// <param name="strFileName">文件名</param>
        public static void ExportByWebExForWTP(DataTable dtSource, string strHeaderText, string strFileName)
        {
            HttpContext curContext = HttpContext.Current;
            ...
            curContext.Response.BinaryWrite(ExportExForWTP(dtSource, strHeaderText).GetBuffer());
            HttpContext.Current.ApplicationInstance.CompleteRequest();
            //curContext.Response.End();
        }
