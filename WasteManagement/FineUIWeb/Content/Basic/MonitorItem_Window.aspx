<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonitorItem_Window.aspx.cs" Inherits="WasteManagement.Content.Basic.MonitorItem_Window" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Form ID="Form2" Width="450px" LabelAlign="Right" MessageTarget="Qtip" Title="新增监测项"
            ...
            <Items>
                ...
                <Items>
                    ...
                    <f:NumberBox ID="WasteCode" Label="监测项目编码" Required="true" Width="350px" LabelWidth="100px" ShowRedStar="true"  CssClass="marginr" runat="server">
                    </f:NumberBox>
                    <f:TextBox ID="WasteName" Label="监测项目名称" Required="true" Width="350px" LabelWidth="100px"  CssClass="marginr" runat="server">
                    </f:TextBox>
