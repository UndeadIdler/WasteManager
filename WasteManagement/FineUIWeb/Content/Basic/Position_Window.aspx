<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Position_Window.aspx.cs" Inherits="WasteManagement.Content.Basic.Position_Window" %>
        ...
        <f:Form ID="Form2" Width="450px" LabelAlign="Right" MessageTarget="Qtip" Title="新增区域"
            ...
            <Items>
                ...
                <Items>
                    ...
                    <f:TextBox ID="txt_name" Label="监测位置名称" Required="true" Width="350px" LabelWidth="100px"  CssClass="marginr" runat="server">
                    </f:TextBox>                                         
