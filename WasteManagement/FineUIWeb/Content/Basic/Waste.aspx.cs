...
{
    public partial class Waste : PageBase, ISingleGridPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                (Master.FindControl("Panel1") as FineUI.Panel).Title = "污染物信息";
        ...
        private DataTable GetPagedDataTable()
        {
            ...
            DataTable table2 = DAL.Waste.QueryWaste(ser_vDirectiveNumber.Text.Trim(), ser_vSaveNumber.Text.Trim());
        ...
        public void DeleteSelectedRows()
        {
            ...
            int BSuccess = DAL.Waste.DeleteWaste(int.Parse(HttpUtility.UrlEncode(keys[0].ToString())));
            if (BSuccess == 1)
            {
        ...
        {
            //if (!beWrite) return "";
            return "Basic/Waste_Window.aspx";
        }
        ...
        public string GetEditUrl()
        {
            //if (!beWrite) return "";
            object[] keys = Grid1.DataKeys[Grid1.SelectedRowIndex];
            return String.Format("Basic/Waste_Window.aspx?ID={0}", HttpUtility.UrlEncode(keys[0].ToString()));
        }
        ...
        protected void btn_Export_Click(object sender, EventArgs e)
        {
            try
            {
                string filename = "物料名称.xls";
                DataTable table2 = DAL.Waste.QueryWasteEx(ser_vDirectiveNumber.Text.Trim(), ser_vSaveNumber.Text.Trim());
                DAL.NPOIHelper.ExportByWebEx(table2, "物料名称表", filename);
