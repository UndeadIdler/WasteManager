...
{
    public partial class PondChange : PageBase, ISingleGridPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                (Master.FindControl("Panel1") as FineUI.Panel).Title = "罐池修正信息";
        ...
        private DataTable GetPagedDataTable()
        {
            ...
            DataTable table2 = DAL.PondChange.QueryPondChange(ser_vDirectiveNumber.Text.Trim(), ser_vSaveNumber.Text.Trim());
        ...
        {
            //if (!beWrite) return "";
            return "Fix/PondChange_Window.aspx";
        }
        ...
        public string GetEditUrl()
        {
            //if (!beWrite) return "";
            object[] keys = Grid1.DataKeys[Grid1.SelectedRowIndex];
            return String.Format("Fix/PondChange_Window.aspx?id={0}", HttpUtility.UrlEncode(keys[0].ToString()));
        }
