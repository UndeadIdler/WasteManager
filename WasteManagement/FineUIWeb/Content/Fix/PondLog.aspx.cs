...
{
    public partial class PondLog : PageBase, ISingleGridPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                (Master.FindControl("Panel1") as FineUI.Panel).Title = "罐池倒库信息";
        ...
        private DataTable GetPagedDataTable()
        {
            ...
            DataTable table2 = DAL.PondLog.QueryPondLog(ser_vDirectiveNumber.Text.Trim(), ser_vSaveNumber.Text.Trim());
        ...
        {
            //if (!beWrite) return "";
            return "Fix/PondLog_Window.aspx";
        }
