...
{
    public partial class TransferPlan:  PageBase, ISingleGridPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                (Master.FindControl("Panel1") as FineUI.Panel).Title = "计划登记";
        ...
        private DataTable GetPagedDataTable()
        {
            ...
            DataTable table2 = DAL.TransferPlan.QueryTransferPlan(txt_ContractNumber.Text.Trim(), txt_Name.Text.Trim(), DateStart.Text.Trim(), DateEnd.Text.Trim(), txt_WasteName.Text.Trim(), int.Parse(drop_Status.SelectedValue.Trim()));
        ...
        protected void btn_Export_Click(object sender, EventArgs e)
        {
            try
            {
                string filename = "转移计划表.xls";
                DataTable table2 = DAL.TransferPlan.QueryTransferPlanEx(txt_ContractNumber.Text.Trim(), txt_Name.Text.Trim(), DateStart.Text.Trim(), DateEnd.Text.Trim(), txt_WasteName.Text.Trim(), int.Parse(drop_Status.SelectedValue.Trim()));
                DAL.NPOIHelper.ExportByWebEx(table2, "转移计划表", filename);
