...
namespace ZWL.Common
{
    ...
    public class PublicMethod
    {
                ...
                if (MyRange[i].ToString().Trim().Length > 0)
                {
                    if (MyReturn.Trim().Length > 0)
                    {
                        ...
                        else
                        {
                            ...
                            MyReturn = MyReturn + "&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/ico_clip.gif /><a target=\"_blank\" href='" + DirStr + MyRange[i].ToString() + "'>" + OldNameStr + "</a>&nbsp;<a href='../DsoFramer/EditFile.aspx?FilePath=" + MyRange[i].ToString() + "' target='_blank'><img border=0 src=../images/Button/ReadFile.gif /></a>";
                        }
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            MyReturn = "<img src=../images/ico_clip.gif /><a target=\"_blank\" href='" + DirStr + MyRange[i].ToString() + "'>" + OldNameStr + "</a>&nbsp;<a href='../DsoFramer/EditFile.aspx?FilePath=" + MyRange[i].ToString() + "' target='_blank'><img border=0 src=../images/Button/ReadFile.gif /></a>";
                        }
                    }
                }
            }
        ...
        public static void CheckSession()
        {
            ...
            try
            {
                if (System.Web.HttpContext.Current.Request.Cookies["Cookies"].Values["UserName"] == null)
                {
